...
ggsave(bio_spp,
       filename = "../results/benthic_pelagic_diversity.png",
       width = 9,
       height = 7)
...
# Save dataset
write_csv(
          "../results/spp_diversity_indices_bp.csv")
...
write_csv(diversity_indices %>% mutate(category = c("Species Richness", "Shannon div.", "Simpson div"),
                                             ,level = "family",n = 11) %>% 
                select(category,everything()),
          "../results/fam_diversity_indices_new.csv")
...
ggsave(
      "../results/diversity_plots_bp_line_new.png",
      pp,
      width = 7,
      height = 5
)
